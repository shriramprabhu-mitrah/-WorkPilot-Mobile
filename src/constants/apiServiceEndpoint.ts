...
export const GET_SPRINT_BURNDOWN = `/{project_id}/sprint-burndown`;
export const GET_TEAM_WORKLOAD = `/{project_id}/team-workload`;
export const GET_WEEKLY_PROGRESS = `/{project_id}/weekly-progress`;
